...
def index() -> str:
    ...
    return (
        ...
        "    derivSyms.forEach(s=>{let box=document.createElement('div');box.innerHTML=`<h3>${s} Bids/Asks</h3><div id='orders-${s.toLowerCase()}' style='width:100%;height:600px;border:1px solid #ccc'></div>`;ordersWrap.appendChild(box);});\n"
        "  }\n"
        "  for(let s of derivSyms){\n"
